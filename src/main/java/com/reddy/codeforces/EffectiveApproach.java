...
public class EffectiveApproach {
    ...
    public static void main(String[] args) throws IOException {
       ...
       // int[] queries = new int[m];
        ...
        // for each queries count forward search Vasya backward for petra
        // key if found ith pos in forwatd compare will be i also backward will be n-i+1
//        for (int i = 0; i < m; i++) {
//            vCount += arr[queries[i]];
//            pCount += n - arr[queries[i]] + 1;
//        }
